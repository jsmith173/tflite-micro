...
==============================================================================*/
#ifndef TENSORFLOW_LITE_MICRO_LIMITED_OPS_RESOLVER_H_
#define TENSORFLOW_LITE_MICRO_LIMITED_OPS_RESOLVER_H_
...
class LimitedOpsResolver : public MicroMutableOpResolver<128> {
 public:
  LimitedOpsResolver();
...
#endif  // TENSORFLOW_LITE_MICRO_LIMITED_OPS_RESOLVER_H_
